...
function applyChartsForm(applyButton) {

    if (applyButton) {

        var form = applyButton.parents("form.charts_form");

        console.error(form.find(".timestepCharts").val() === "MINUTE");
        console.error(form.find(".timestepCharts").val());

        $("#preset_ChartsForm").val(form.find(".timestepCharts").val());

        form.find(".timestepCharts").val() === "MINUTE" ? $(".minute_only").removeClass("hidden") : $(".minute_only").addClass("hidden");
        form.find(".timestepCharts").val() === "HOURLY" ? $(".hourly_only").removeClass("hidden") : $(".hourly_only").addClass("hidden");


        $("#dateDebCharts").val(form.find(".fromDate_ChartsForm").data("DateTimePicker").date().format('YYYY-MM-DD HH:mm'));
        $("#dateFinCharts").val(form.find(".toDate_ChartsForm").data("DateTimePicker").date().format('YYYY-MM-DD HH:mm'));
        ...
        console.log($("#timestepCharts").val() === "MINUTE");
        console.log($("#timestepCharts").val());
